        ...
        <div className='h-screen flex items-center justify-center font-serif'>
            <div className='flex flex-col items-center w-[70vw] md:w-[40vw] lg:w-[30vw] rounded-2xl gap-2 border-1 border-gray-400 p-2 md:p-4'>
                <div className='flex flex-col items-center justify-center gap-2'>
                    <p className='text-green-400 font-semibold text-[6vw] md:text-[3.5vw] lg:text-[2.5vw]'>New Password</p>
                ...
                <button onClick={newPassword} className='lg:h-10 h-8 bg-green-400 w-full rounded-xl hover:bg-green-500 md:text-lg'>Submit</button>
            </div>
        </div>
    );
};
