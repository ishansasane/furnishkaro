    ...
    return (
        <div className="w-full p-4 sm:p-6 flex flex-col min-h-screen">
            <div className="flex mt-5 flex-wrap flex-row justify-between items-center mb-6">
                <h1 className="text-lg sm:text-2xl !items-center  font-semibold">Payments</h1>
                <button 
                    onClick={() => navigate("/")} 
                        ...
                        {filteredPayments.length !== 0 && filteredPayments.map((payment, index) => (
                            <tr className="hover:bg-sky-50" key={index}>
                                ...
                                <td className="p-2 flex flex-row gap-2">
                                    <button 
                                        onClick={() => deletePayment(payment[0], payment[1], payment[2], payment[3], payment[4], payment[5])} 
                        ...
                        <div className="flex flex-col gap-4">
                            <div className="flex flex-col">
                                <div className="flex flex-row gap-1 items-center">
                                    <label className="text-sm sm:text-base">Amount Received</label>
