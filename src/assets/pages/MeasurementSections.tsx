                    ...
                    >
                      <div className="flex flex-col sm:flex-row w-full sm:gap-2 md:gap-2">
                        <div className="flex flex-col gap-1 sm:gap-2 w-full sm:w-1/5">
                          <p className="text-xs sm:text-sm md:text-base">Product Group</p>
                          <input
                            type="text"
                        ...
                        <div className="flex flex-col gap-1 sm:gap-2 w-full sm:w-1/5">
                          <p className="text-xs sm:text-sm md:text-base">Reference</p>
                          <input
                            type="text"
                        ...
                        <div className="flex flex-col gap-1 sm:gap-2 w-full sm:w-1/5">
                          <p className="text-xs sm:text-sm md:text-base">Measurement</p>
                          <select
                        ...
                        <div className="flex flex-col gap-1 sm:gap-2 w-full sm:w-1/6">
                          <p className="text-xs sm:text-sm md:text-base">Width</p>
                          <input
                        ...
                        <div className="flex flex-col gap-1 sm:gap-2 w-full sm:w-1/6">
                          <p className="text-xs sm:text-sm md:text-base">Height</p>
                          <input
                        ...
                        <div className="flex flex-col gap-1 sm:gap-2 w-full sm:w-1/6">
                          <p className="text-xs sm:text-sm md:text-base">Quantity</p>
                          <input
                            type="number"
                      ...
                      <div className="flex flex-col gap-1 sm:gap-2 sm:w-1/6">
                      </div>
                    </div>
                  ))}
                </div>
